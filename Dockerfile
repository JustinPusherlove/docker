...
RUN pip install blessings==1.7 chromedriver-py==91.0.4472.19 colorama==0.4.4 cycler==0.10.0 cython==0.29.21 kiwisolver==1.2.0 matplotlib==3.3.0 numpy==1.16.1 easydict
